...
public interface ChunkSystemRegionFileStorage {
    ...
    public abomination.IRegionFile moonrise$getRegionFileIfLoaded(final int chunkX, final int chunkZ);

    public abomination.IRegionFile moonrise$getRegionFileIfExists(final int chunkX, final int chunkZ) throws IOException;
