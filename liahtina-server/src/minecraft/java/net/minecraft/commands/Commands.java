...
public class Commands {
    ...
    // Paper end - Brigadier API - modern minecraft overloads that do not use redirects but are copies instead
        ...
        BossBarCommands.register(this.dispatcher, context); // Liahtina - re-enable /bossbar command
        ClearInventoryCommands.register(this.dispatcher, context);
        CloneCommands.register(this.dispatcher, context); // Liahtina - re-enable /clone command
        DamageCommand.register(this.dispatcher, context);
        DataCommands.register(this.dispatcher); // Liahtina - re-enable /data command (vanilla datapack support)
        DataPackCommand.register(this.dispatcher, context); // Liahtina - re-enable /datapack command
        DebugCommand.register(this.dispatcher); // Liahtina - re-enable /debug command
        DefaultGameModeCommands.register(this.dispatcher);
        DialogCommand.register(this.dispatcher, context); // Liahtina - re-enable /dialog command
        ...
        FunctionCommand.register(this.dispatcher); // Liahtina - re-enable /function command (vanilla datapack support; depends on DataCommands)
        GameModeCommand.register(this.dispatcher);
        GameRuleCommand.register(this.dispatcher, context);
        GiveCommand.register(this.dispatcher, context);
        HelpCommand.register(this.dispatcher);
        ItemCommands.register(this.dispatcher, context); // Liahtina - re-enable /item command (note: block targets have Folia thread-safety risk)
        KickCommand.register(this.dispatcher);
        KillCommand.register(this.dispatcher);
        ListPlayersCommand.register(this.dispatcher);
        LocateCommand.register(this.dispatcher, context);
        LootCommand.register(this.dispatcher, context); // Liahtina - re-enable /loot command (note: block targets have Folia thread-safety risk)
        ...
        ReloadCommand.register(this.dispatcher); // Liahtina - re-enable /reload command for datapack support
        RecipeCommand.register(this.dispatcher);
        FetchProfileCommand.register(this.dispatcher);
        ReturnCommand.register(this.dispatcher); // Liahtina - re-enable /return command
        RideCommand.register(this.dispatcher);
        RotateCommand.register(this.dispatcher);
        SayCommand.register(this.dispatcher);
        ScheduleCommand.register(this.dispatcher); // Liahtina - re-enable /schedule command (per-world TimerQueue, Folia-safe)
        ScoreboardCommand.register(this.dispatcher, context); // Liahtina - re-enable /scoreboard command (server-level data, Folia-safe)
        ...
        SpectateCommand.register(this.dispatcher); // Liahtina - re-enable /spectate command
        SpreadPlayersCommand.register(this.dispatcher); // Liahtina - re-enable /spreadplayers command
        StopSoundCommand.register(this.dispatcher);
        StopwatchCommand.register(this.dispatcher);
        SummonCommand.register(this.dispatcher, context);
        TagCommand.register(this.dispatcher); // Liahtina - re-enable /tag command
        TeamCommand.register(this.dispatcher, context); // Liahtina - re-enable /team command
        TeamMsgCommand.register(this.dispatcher); // Liahtina - re-enable /teammsg command
        TeleportCommand.register(this.dispatcher);
        TellRawCommand.register(this.dispatcher, context);
        TestCommand.register(this.dispatcher, context); // Liahtina - re-enable /test command
        TickCommand.register(this.dispatcher); // Liahtina - re-enable /tick command (note: limited effect under Folia region threading)
        TimeCommand.register(this.dispatcher, context);
        TitleCommand.register(this.dispatcher, context);
        TriggerCommand.register(this.dispatcher); // Liahtina - re-enable /trigger command
        WaypointCommand.register(this.dispatcher, context); // Liahtina - re-enable /waypoint command
        ...
        if (commandSelection.includeDedicated) {
            ...
            PerfCommand.register(this.dispatcher); // Liahtina - re-enable /perf command
            SaveAllCommand.register(this.dispatcher); // Liahtina - re-enable /save-all command
